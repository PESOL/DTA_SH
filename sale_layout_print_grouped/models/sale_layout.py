...
class SaleOrder(models.Model):
    ...
    #             'quote_category_id': layout_category.id
    #         }
    #         categories.append([0, 0, data])
    #
    #     self.sale_layout_category_ids = categories
    #
    #     order_lines = [(5, 0, 0)]
    ...
    #             'layout_category_id': self.sale_layout_category_ids.filtered(
    #                 lambda c:
    #                 c.quote_category_id.id == line.layout_category_id.id
    #             ).id,
